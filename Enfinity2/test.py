...
def main():
    ...
    parser.add_argument("--tta_scales", type=str, default="0.5,0.75,1.0,1.25,1.5,1.75", 
    ...
    model_path = args.model_path or os.path.join(base_output, "checkpoints", "nexus_model.pth")
