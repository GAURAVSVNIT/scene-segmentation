...
class NexusFusionBlock(nn.Module):
    def __init__(self, channels):
        super().__init__()
...
class NexusDecoder(nn.Module):
    def __init__(self, in_channels=1024, num_classes=10, TH=19, TW=34, feat_dim=256):
        ...
        self.shallow_cnn = TextureExtractor(out_channels=64)
        ...
        # DPT Fusion Blocks
        self.fusion4 = NexusFusionBlock(feat_dim)
        self.fusion3 = NexusFusionBlock(feat_dim)
        self.fusion2 = NexusFusionBlock(feat_dim)
        self.fusion1 = NexusFusionBlock(feat_dim)
    ...
    def forward(self, x_raw, backbone_features):
        ...
        # 4. Align DPT features with TextureExtractor spatial grid
